const instructions = [
  {
    ...
    instruction: `
      ...
      <h3>Rock Paper Scissors: Classic</h3>
        <p>
          This game mode represents the most classic approach to the original
          Rock Paper Scissors we all know and love, but using cards.
        </p>

      <h4>How to Play</h4>
        <p>1. After selecting "Classic" mode, choose the deck size (18, 36, or 54)
           and deal shuffled deck by clicking the <strong>Start Game</strong>
           button.
        </p>
        <p>
          2. Player must click/tap a card from their hand to play against the AI.
        </p>
        <p>
        ...
        <p>
          4. Play continues until one player holds all cards and wins the game.
        </p>
      <br>
    <h4>A Note on tie rounds</h4>
      ...
      <p>
        ...
        to win the tie and thus lose the game.
      </p>
      <br>
    <h4>More Notes:</h4>
      <p>
